<template>
  ...
  >
    ...
    <button
      :id="`hud-mute-button-${templateSuffix}`"
      ...
      :class="{
        'bg-red-500/10 border-red-500/30': soundStore.isMuted,
      }"
    >
      <svg
        v-if="!soundStore.isMuted"
        ...
        stroke="currentColor"
      >
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.536 8.464a5 5 0 010 7.072m2.828-9.9a9 9 0 010 12.728M5 10v4a2 2 0 002 2h2.586l4.707 4.707A.999.999 0 0016 20V4a.999.999 0 00-1.707-.707L9.586 8H7a2 2 0 00-2 2z" />
      </svg>
      <svg
        v-else
        xmlns="http://www.w3.org/2000/svg"
