...
<div
  ...
  class="w-full max-w-md mx-auto
         ...
         shadow-lg transition-all hover:bg-white/10"
>
    <div
    ...
    >
      ...
      >
        <span class="text-[8px] sm:text-[9px] font-black text-gray-500 uppercase tracking-widest mb-1">
          Win
        </span>
      ...
      >
        ...
        <div class="flex items-baseline gap-0.5 leading-none">
          <span class="text-lg sm:text-xl font-mono font-black text-blue-400 tracking-tighter">
            {{ Math.round(tieProb) }}
          </span>
