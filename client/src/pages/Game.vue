<template>
  ...
  >
    ...
    <main
      id="viewport-stage"
      class="flex-grow flex items-center justify-center relative overflow-hidden bg-[radial-gradient(circle_at_center,_#1a2e1a_0%,_#0a0a0a_100%)]"
    >
      <!-- Ambient Lights -->
      <div
...
const opponents = computed(() =>
  allPlayers.value.filter((p) => p.id !== myPlayer.value?.id),
)
