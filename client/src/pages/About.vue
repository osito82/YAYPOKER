<template>
  <div
    :id="`about-viewport-${templateSuffix}`"
    class="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-white font-sans selection:bg-yellow-500 selection:text-black overflow-x-hidden transition-colors duration-300"
  >
    <!-- Navbar Minimalista -->
    <nav
    ...
    >
      ...
      <router-link
        ...
        class="text-[10px] font-black uppercase tracking-[0.3em] text-gray-400 dark:text-gray-500 hover:text-yellow-600 dark:hover:text-yellow-500 transition-colors"
      >
        {{ $t('pages.about.back') }}
      </router-link>
    </nav>
    ...
    <main
      :id="`about-main-content-${templateSuffix}`"
      class="max-w-4xl mx-auto px-6 py-20 relative"
    >
      <div
      ...
      <header
        :id="`about-header-section-${templateSuffix}`"
        class="text-center mb-20"
      >
        <div
          :id="`about-eyebrow-badge-${templateSuffix}`"
          class="inline-block px-4 py-1 bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-full mb-6"
        >
          <span
            class="text-yellow-600 dark:text-yellow-500 font-mono text-[10px] font-black uppercase tracking-[0.3em]"
          >
            {{ $t('pages.about.philosophy_badge') }}
          </span>
        </div>
        <h1
        ...
        <p
          ...
          class="text-gray-500 dark:text-gray-400 text-lg md:text-xl font-bold uppercase tracking-wide leading-relaxed"
        >
      ...
      <section
        :id="`about-philosophy-grid-${templateSuffix}`"
        class="grid md:grid-cols-2 gap-12 mb-20"
      >
        <div
          :id="`about-card-free-${templateSuffix}`"
          class="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-8 rounded-[2rem]"
        >
          <h3
          ...
          >
            {{ $t('pages.about.why_free_desc') }}
          </p>
        </div>
        <div
          :id="`about-card-fast-${templateSuffix}`"
          class="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 p-8 rounded-[2rem]"
        >
          <h3
            class="text-2xl font-black uppercase italic mb-4 text-gray-900 dark:text-white"
          ...
          <p
            class="text-gray-500 dark:text-gray-500 text-sm leading-relaxed font-bold uppercase tracking-widest"
          >
            {{ $t('pages.about.why_fast_desc') }}
          </p>
        </div>
      </section>

      <footer
        :id="`about-page-footer-${templateSuffix}`"
        class="text-center border-t border-gray-200 dark:border-white/5 pt-20"
      >
        <h2
        ...
        <p
          ...
          class="text-gray-400 dark:text-gray-600 text-xs font-black uppercase tracking-[0.4em]"
        >
