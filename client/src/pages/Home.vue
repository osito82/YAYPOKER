<template>
  <div class="min-h-screen bg-gray-900 flex flex-col items-center justify-center p-4">
    <div class="w-full max-w-md bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-700">
      ...
      <!-- Header -->
      <div class="bg-gray-700 p-6 flex flex-col items-center border-b border-gray-600">
        <Logo class="mb-4 transform scale-125" />
        <h2 class="text-gray-300 text-lg font-light tracking-wide">Texas Hold'em Lobby</h2>
      </div>
      ...
      <div class="p-8 space-y-6">
        ...
        <div class="relative flex py-2 items-center">
            ...
            <span class="flex-shrink mx-4 text-gray-500 text-xs">JOIN OR CREATE</span>
            <div class="flex-grow border-t border-gray-600"></div>
        </div>

        <!-- Join Game -->
        <div class="space-y-3">
             <label class="block text-gray-400 text-sm font-bold mb-1" for="gamecode">
            Game Code
          </label>
