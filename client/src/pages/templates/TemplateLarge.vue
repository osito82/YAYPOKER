<template>
  ...
  >
    ...
    >
      <!-- LEFT SECTION -->
      <div id="header-left-section" class="flex items-center gap-4">
        <div
      ...
      <!-- RIGHT SECTION -->
      <div id="header-right-section" class="flex items-center gap-4">
        <div id="header-players-counter" class="flex items-center gap-1.5 bg-white/5 px-2 py-1 rounded border border-white/5">
        ...
        <div id="status-panel" class="bg-black/40 px-3 py-1 rounded-full border border-white/5 flex items-center gap-2 shrink-0">
        ...
        <div id="player-badge" class="bg-yellow-500/10 px-4 py-1 rounded-full border border-yellow-500/20 shrink-0">
          <span class="text-[12px] font-black text-yellow-500 uppercase tracking-widest">{{ playerName }}</span>
        </div>
        <div id="server-time-container" class="flex flex-col items-end leading-none border-l border-white/10 pl-4">
    ...
    <div id="main-layout-container" class="flex-grow flex flex-row overflow-hidden relative">
      <!-- TOP AREA -->
      <div id="game-primary-area" class="flex flex-col min-w-0 relative flex-[7] h-full">
        <main id="viewport-stage" class="flex-grow flex flex-col overflow-hidden bg-[radial-gradient(circle_at_center,_#1a2e1a_0%,_#0a0a0a_100%)]">
          <div id="table-area" class="flex-grow relative min-h-0">
            <PokerTable
