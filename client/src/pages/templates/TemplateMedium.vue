<template>
  ...
  >
    ...
    <header
      ...
      class="w-full relative bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/5 px-4 flex items-center justify-between z-50 shrink-0 min-h-[56px]"
    >
      <!-- LEFT SECTION -->
      <div
      ...
      <div class="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-10 flex items-center justify-center pointer-events-none">
        <div class="transform scale-[0.80] md:scale-90 origin-center pointer-events-auto">
