<template>
  ...
  >
    ...
    >
      <!-- LEFT SECTION -->
      <div id="header-left-section" class="flex items-center gap-3">
        <div
      ...
      <!-- RIGHT SECTION -->
      <div id="header-right-section" class="flex items-center gap-3">
        ...
        <div id="player-badge" class="bg-yellow-500/10 px-3 py-0.5 rounded-full border border-yellow-500/20 shrink-0">
    ...
    <div id="main-layout-container" class="flex-grow flex flex-col md:flex-row overflow-hidden relative">
      <!-- TOP AREA -->
