<template>
  ...
  >
    ...
    >
      <!-- LEFT SECTION -->
      <div id="header-left-content-TemplateSmall" class="flex items-center gap-2">
        <div
        ...
        >
          <span id="logo-text-icon-TemplateSmall" class="text-black font-black text-sm">O</span>
        </div>
        <div id="game-metadata-info-TemplateSmall" class="flex flex-col justify-center">
      ...
      <!-- RIGHT SECTION -->
      <div id="header-right-content-TemplateSmall" class="flex items-center gap-2">
        <div id="connection-status-panel-TemplateSmall" class="bg-black/40 px-2 py-0.5 rounded-full border border-white/5 flex items-center gap-1.5 shrink-0">
        ...
        <div id="current-player-badge-TemplateSmall" class="bg-yellow-500/10 px-2 py-0.5 rounded-full border border-yellow-500/20 max-w-[70px] shrink-0">
    ...
    <div id="main-game-layout-TemplateSmall" class="flex-grow flex flex-col overflow-hidden relative">
      <!-- TOP AREA -->
      <div id="primary-game-view-TemplateSmall" class="flex flex-col min-w-0 relative flex-[4]">
        <main id="poker-table-viewport-TemplateSmall" class="flex-none h-auto overflow-hidden bg-[radial-gradient(circle_at_center,_#1a2e1a_0%,_#0a0a0a_100%)]">
          <div id="poker-table-container-TemplateSmall" class="flex-none relative min-h-0">
            <PokerTable
