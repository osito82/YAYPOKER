...
// New modules
const actions = require('./match/actions')
const timers = require('./match/timers')
...
class Match {
  ...
  signUp(data, thisSocket) {
    return lobby.signUp(this, data, thisSocket)
  }

  playerReady(thisSocket) {
    return lobby.playerReady(this, thisSocket)
  }

  noMorePlayers() {
    return lobby.noMorePlayers(this)
  }

  playerLeave(thisSocket) {
    return lobby.playerLeave(this, thisSocket)
  }

  pause(thisSocket) {
    return lobby.pause(this, thisSocket)
  }

  close(thisSocket) {
    return lobby.close(this, thisSocket)
  }

  // --- TIMER METHODS ---
  startAutofold() {
    return timers.startAutofold(this)
  }

  clearAutofold() {
    return timers.clearAutofold(this)
  }

  startLobbyTimer() {
    return timers.startLobbyTimer(this)
  }

  clearLobbyTimer() {
    return timers.clearLobbyTimer(this)
  }

  // --- ACTION METHODS ---
  setBet(thisSocket, chipsToBet, type = 'setBet') {
    return actions.setBet(this, thisSocket, chipsToBet, type)
  }

  setCall(thisSocket) {
    return actions.setCall(this, thisSocket)
  }

  setCheck(thisSocket) {
    return actions.setCheck(this, thisSocket)
  }

  setRise(thisSocket, chipsToBet) {
    return actions.setRise(this, thisSocket, chipsToBet)
  }

  fold(thisSocket) {
    return actions.fold(this, thisSocket)
  }

  performCheck(foundPlayer) {
    return actions.performCheck(this, foundPlayer)
  }
