...
class WinnerCertificate {
  ...
  static verifyCertificate(torneoId, providedCode) {
    ...
    if (!cert) {
      return { valid: false, error: "Este torneo no tiene un certificado de ganador registrado." };
    }
...
if (providedCode === expectedCode || providedCode === cert.code) {
    ...
    return { valid: false, error: "El código ingresado no coincide con el certificado oficial." };
  }
